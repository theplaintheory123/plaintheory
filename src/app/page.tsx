...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between sm:h-20">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-600 to-blue-700 shadow-lg sm:h-10 sm:w-10 sm:rounded-xl">
                <span className="text-lg font-bold text-white sm:text-xl">P</span>
              </div>
              <span className="text-xl font-bold text-slate-900 sm:text-2xl">Plantheory</span>
            </div>
            ...
            <div className="hidden items-center gap-4 md:flex">
              <Link href="/auth/login" className="text-sm font-medium text-slate-700 transition-colors hover:text-indigo-600">
                Sign In
              </Link>
              <Link href="/auth/signup" className="rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition-all hover:shadow-xl hover:shadow-indigo-500/40">
                Get Started
              </Link>
            </div>
            ...
            <div className="flex items-center gap-3 md:hidden">
              <Link href="/auth/signup" className="rounded-lg bg-gradient-to-r from-indigo-600 to-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-md">
                Get Started
              </Link>
              <button
        ...
        {mobileMenuOpen && (
          <div className="border-t border-slate-200 bg-white md:hidden">
            <div className="space-y-1 px-4 py-4">
              <a href="#features" onClick={() => setMobileMenuOpen(false)} className="block rounded-lg px-4 py-3 text-base font-medium text-slate-700 hover:bg-slate-100">Features</a>
              <a href="#solutions" onClick={() => setMobileMenuOpen(false)} className="block rounded-lg px-4 py-3 text-base font-medium text-slate-700 hover:bg-slate-100">Solutions</a>
              <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="block rounded-lg px-4 py-3 text-base font-medium text-slate-700 hover:bg-slate-100">Pricing</a>
              <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="block rounded-lg px-4 py-3 text-base font-medium text-slate-700 hover:bg-slate-100">Contact</a>
              <div className="border-t border-slate-200 pt-4">
                <Link href="/auth/login" onClick={() => setMobileMenuOpen(false)} className="block rounded-lg px-4 py-3 text-base font-medium text-indigo-600 hover:bg-indigo-50">Sign In</Link>
              </div>
            </div>
          </div>
        )}
      ...
      {/* Hero Section */}
      <section className="px-4 pb-16 pt-24 sm:px-6 sm:pb-20 sm:pt-32 lg:px-8 lg:pb-32 lg:pt-40">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1.5 text-xs font-semibold text-indigo-700 shadow-sm sm:mb-8 sm:px-4 sm:py-2 sm:text-sm">
              <svg className="h-3 w-3 sm:h-4 sm:w-4" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              Trusted by 500+ growing businesses
            </div>
            <h1 className="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-slate-900 sm:mb-6 sm:text-5xl lg:text-7xl">
            ...
            <p className="mb-8 text-base leading-relaxed text-slate-600 sm:mb-10 sm:text-xl lg:text-2xl">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center sm:gap-4">
              <Link href="/auth/signup" className="group rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-3.5 text-base font-semibold text-white shadow-xl shadow-indigo-500/30 transition-all hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/40 sm:px-8 sm:py-4">
              ...
              <a href="#contact" className="rounded-xl border-2 border-slate-300 bg-white px-6 py-3.5 text-base font-semibold text-slate-900 shadow-lg transition-all hover:border-indigo-600 hover:bg-slate-50 sm:px-8 sm:py-4">
                Schedule Demo
              </a>
            </div>
          ...
          {/* Hero Visual */}
          <div className="mx-auto mt-12 max-w-6xl sm:mt-20">
            <div className="relative rounded-xl border border-slate-300 bg-gradient-to-b from-slate-100 to-white p-2 shadow-2xl sm:rounded-2xl sm:p-4">
              ...
              <div className="relative aspect-[16/10] overflow-hidden rounded-lg bg-gradient-to-br from-slate-900 via-indigo-900 to-blue-900 p-4 shadow-inner sm:aspect-video sm:rounded-xl sm:p-8">
                <div className="flex h-full flex-col gap-3 sm:gap-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="ml-2 h-6 flex-1 rounded bg-slate-700/50 sm:ml-4 sm:h-8 sm:rounded-md"></div>
                  </div>
                  <div className="flex flex-1 gap-2 sm:gap-4">
                    <div className="hidden w-1/4 space-y-2 sm:block sm:space-y-3">
                      <div className="h-8 rounded-lg bg-indigo-500/30 sm:h-10"></div>
                      <div className="h-6 rounded-lg bg-slate-700/50 sm:h-8"></div>
                      <div className="h-6 rounded-lg bg-slate-700/50 sm:h-8"></div>
                      <div className="h-6 rounded-lg bg-slate-700/50 sm:h-8"></div>
                    </div>
                    <div className="flex-1 space-y-2 rounded-lg bg-slate-800/50 p-3 sm:space-y-4 sm:rounded-xl sm:p-6">
                      <div className="h-6 w-3/4 rounded bg-indigo-500/40 sm:h-10 sm:rounded-lg"></div>
                      <div className="space-y-1.5 sm:space-y-2">
                        <div className="h-3 w-full rounded bg-slate-700/50 sm:h-4"></div>
                        <div className="h-3 w-full rounded bg-slate-700/50 sm:h-4"></div>
                        <div className="h-3 w-5/6 rounded bg-slate-700/50 sm:h-4"></div>
                      </div>
                      <div className="mt-3 grid grid-cols-2 gap-2 sm:mt-6 sm:gap-3">
                        <div className="h-12 rounded-lg bg-slate-700/30 sm:h-20"></div>
                        <div className="h-12 rounded-lg bg-slate-700/30 sm:h-20"></div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mx-auto mt-12 max-w-5xl sm:mt-20">
            <p className="mb-6 text-center text-xs font-semibold uppercase tracking-wider text-slate-500 sm:mb-8 sm:text-sm">
              Trusted by Industry Leaders
            </p>
            <div className="grid grid-cols-2 gap-4 opacity-50 grayscale sm:gap-8 md:grid-cols-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex items-center justify-center">
                  <div className="h-6 w-24 rounded bg-slate-300 sm:h-8 sm:w-32"></div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="mb-1 text-2xl font-bold text-indigo-600 sm:mb-2 sm:text-4xl">{stat.value}</div>
      ...
      <section className="bg-slate-50 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center sm:mb-16">
            ...
            <h2 className="mb-4 text-2xl font-bold text-slate-900 sm:mb-6 sm:text-4xl lg:text-5xl">
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={index} className="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-indigo-200 hover:shadow-xl sm:rounded-2xl sm:p-8">
                <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-red-50 to-orange-50 text-red-600 transition-all group-hover:scale-110 sm:mb-4 sm:h-14 sm:w-14 sm:rounded-xl">
                  {problem.icon}
                </div>
                <h3 className="mb-2 text-lg font-bold text-slate-900 sm:mb-3 sm:text-xl">{problem.title}</h3>
                <p className="mb-3 text-sm leading-relaxed text-slate-600 sm:mb-4 sm:text-base">{problem.description}</p>
                <div className="inline-flex items-center gap-1.5 rounded-full bg-red-50 px-2.5 py-1 text-xs font-semibold text-red-700 sm:gap-2 sm:px-3">
                  <svg className="h-3 w-3 sm:h-4 sm:w-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              {[
                ...
                <div key={index} className="group">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className={`flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${feature.gradient} text-2xl shadow-lg ${feature.shadow} transition-all group-hover:scale-110 sm:h-16 sm:w-16 sm:rounded-2xl sm:text-3xl`}>
                      {feature.emoji}
                    </div>
                    <div className="flex-1">
                      <h3 className="mb-2 text-xl font-bold text-slate-900 sm:mb-3 sm:text-2xl">{feature.title}</h3>
                      <p className="mb-3 text-sm leading-relaxed text-slate-600 sm:mb-4 sm:text-lg">{feature.description}</p>
                      <ul className="space-y-1.5 sm:space-y-2">
                        {feature.features.map((item, idx) => (
                          <li key={idx} className="flex items-center gap-2 text-sm text-slate-700 sm:text-base">
      ...
      {/* Use Cases Section */}
      <section id="solutions" className="scroll-mt-20 bg-slate-50 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center sm:mb-16">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 sm:mb-6 sm:text-4xl lg:text-5xl">
          ...
          <div className="grid gap-4 sm:gap-8 md:grid-cols-2">
            {[
              ...
              <div key={index} className="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-indigo-300 hover:shadow-xl sm:rounded-2xl sm:p-8">
                <div className="mb-3 text-4xl sm:mb-4 sm:text-5xl">{useCase.icon}</div>
                <h3 className="mb-2 text-xl font-bold text-slate-900 sm:mb-3 sm:text-2xl">{useCase.title}</h3>
                <p className="mb-4 text-sm text-slate-600 sm:mb-6 sm:text-lg">{useCase.description}</p>
                <ul className="space-y-1.5 sm:space-y-2">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-4 sm:gap-8 md:grid-cols-3">
            {[
              ...
              <div key={index} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm sm:rounded-2xl sm:p-8">
                ...
                <p className="mb-4 text-sm italic leading-relaxed text-slate-700 sm:mb-6 sm:text-lg">"{testimonial.quote}"</p>
                <div>
                  ...
                  <div className="text-xs text-slate-500 sm:text-sm">{testimonial.company}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-slate-900 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center sm:mb-16">
            <h2 className="mb-4 text-2xl font-bold text-white sm:mb-6 sm:text-4xl lg:text-5xl">
          ...
          <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                title: "SSO & 2FA",
                description: "Seamless identity provider integration"
              },
              {
                icon: (
                  <svg className="h-6 w-6 sm:h-8 sm:w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div key={index} className="text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-white/10 text-indigo-400 sm:mb-4 sm:h-16 sm:w-16 sm:rounded-2xl">
                  {feature.icon}
                </div>
                <h3 className="mb-1 text-sm font-bold text-white sm:mb-2 sm:text-lg">{feature.title}</h3>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="scroll-mt-20 bg-slate-50 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center sm:mb-16">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 sm:mb-6 sm:text-4xl lg:text-5xl">
          ...
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-3">
            {[
              ...
              <div
                key={index}
                className={`relative rounded-2xl border-2 p-5 shadow-sm sm:rounded-3xl sm:p-8 ${
                  plan.highlighted
              ...
              >
                ...
                <div className="mb-4 sm:mb-6">
                  <h3 className="mb-1 text-xl font-bold text-slate-900 sm:mb-2 sm:text-2xl">{plan.name}</h3>
                  <div className="mb-2 flex items-baseline sm:mb-3">
                    <span className="text-3xl font-extrabold text-slate-900 sm:text-5xl">{plan.price}</span>
                    {plan.period && <span className="ml-1 text-sm text-slate-600 sm:ml-2">{plan.period}</span>}
                  </div>
                  <p className="text-sm text-slate-600 sm:text-base">{plan.description}</p>
                </div>
                <ul className="mb-6 space-y-2 sm:mb-8 sm:space-y-3">
                  {plan.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-2 sm:gap-3">
                      <svg className="h-5 w-5 flex-shrink-0 text-indigo-600 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                ...
                <Link
                  href={plan.href}
                  className={`block w-full rounded-xl py-2.5 text-center text-sm font-semibold transition-all sm:py-3 sm:text-base ${
                    plan.highlighted
      ...
      <section id="contact" className="scroll-mt-20 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-blue-600 to-indigo-800 px-6 py-12 text-center shadow-2xl shadow-indigo-500/40 sm:rounded-3xl sm:px-16 sm:py-20">
            ...
            <div className="relative">
              <h2 className="mb-3 text-2xl font-extrabold text-white sm:mb-4 sm:text-4xl lg:text-5xl">
                Ready to Transform Your Operations?
              </h2>
              <p className="mb-8 text-base text-indigo-100 sm:mb-10 sm:text-xl">
                Join hundreds of companies that have eliminated operational chaos with Plantheory
              </p>
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-center sm:gap-4">
                <Link href="/auth/signup" className="group rounded-xl bg-white px-6 py-3.5 text-base font-semibold text-indigo-600 shadow-xl transition-all hover:scale-105 hover:bg-indigo-50 sm:px-8 sm:py-4">
                  Start Free 30-Day Trial
                  <svg className="ml-2 inline-block h-5 w-5 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </Link>
                <a href="#contact" className="rounded-xl border-2 border-white/30 bg-white/10 px-6 py-3.5 text-base font-semibold text-white backdrop-blur-sm transition-all hover:bg-white/20 sm:px-8 sm:py-4">
                  Schedule a Demo
                </a>
              </div>
              <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs text-indigo-100 sm:mt-8 sm:gap-6 sm:text-sm">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 bg-white px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 sm:gap-12 lg:grid-cols-5">
            <div className="lg:col-span-2">
              ...
              <p className="mb-4 max-w-md text-sm text-slate-600 sm:mb-6 sm:text-base">
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="#features" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Features</a></li>
                <li><a href="#solutions" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Solutions</a></li>
                <li><a href="#pricing" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Pricing</a></li>
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Updates</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">About</a></li>
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Customers</a></li>
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Blog</a></li>
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Careers</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Documentation</a></li>
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Help Center</a></li>
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Security</a></li>
                <li><a href="#" className="text-sm text-slate-600 transition-colors hover:text-indigo-600 sm:text-base">Privacy</a></li>
              </ul>
            </div>
          </div>
